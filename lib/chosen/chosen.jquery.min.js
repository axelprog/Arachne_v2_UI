...
(function () {
    ...
    n = this, e = jQuery, e.fn.extend({chosen: function (n) {
        ...
        return i(r, t), r.prototype.setup = function () {
            ...
            var n, r, i = this;
            return n = e("<li />", {"class": "search-choice"}).html("<span>" + t.html + "</span>"), t.disabled ? n.addClass("search-choice-disabled") : (r = e("<a />", {href: "#", "class": "search-choice-close", rel: t.array_index}), r.click(function (e) {
